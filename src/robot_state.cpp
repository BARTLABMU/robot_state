...
{
    FL_angle=leg->data[0]-90;
    FR_angle = leg->data[1]-90;
    BL_angle = leg->data[2]-90;
    BR_angle = leg->data[3]-90;
    J1_angle = leg->data[4]-90;
    J2_angle = leg->data[5];
    J3_angle = leg->data[6];
    J4_angle = leg->data[7];
    J5_angle = leg->data[8];
...
Robot_pose.pose.orientation =  tf::createQuaternionMsgFromRollPitchYaw(0,0,0);
 ...
 ros::Rate loop_rate(100);
    ...
    while (ros::ok()) {
       ...
       // j4_ro = (J4_angle-180)*degree;
        j4_ro = J4_angle*0.001;
        j5_ro = (J5_angle)*degree;
        j6_ro = (J6_angle)*degree;
     ...
     /*   odom.header.stamp = ros::Time::now();
        ...
        odom.transform.rotation = tf::createQuaternionMsgFromRollPitchYaw(0,0,0);*/
